...
(function logCoreModule() {
    ...
    const LEGACY_LOG_RULES = [
        ...
        { re: /^undo → /i, tier: 'action', category: 'Phrase' },
        { re: /^redo → /i, tier: 'action', category: 'Phrase' },
        ...
        { re: /^Phrase: (?:undo|redo|compressed)/i, tier: 'action', category: 'Phrase' },
        { re: /^Phrase boundary /i, tier: 'action', category: 'Phrase' },
        { re: /^Phrase [A-Z]{1,2} (?:absorbed into|merged)/i, tier: 'action', category: 'Phrase' },
        { re: /^Phrase:/i, tier: 'detail', category: 'Phrase' },
        { re: /^Musical Grid: (?:ON|OFF)/i, tier: 'action', category: 'Phrase' },
        { re: /^Phrase tint: (?:ON|OFF)/i, tier: 'action', category: 'Phrase' },
